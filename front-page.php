...
<div class="flex flex-col w-full">
    ...
    <section class="relative w-full overflow-hidden bg-primary-container text-on-primary">
        ...
        <div class="py-2.5 px-4 flex items-center justify-between overflow-x-auto whitespace-nowrap border-t border-b" style="background-color: #F0EDE4; border-color: #B7C7D9; color: #1F2F4F;">
            <div class="flex items-center gap-4 sm:gap-6 font-label-badge text-label-badge uppercase tracking-widest font-extrabold text-center w-full justify-center">
                ...
                <span class="font-black hidden sm:inline" style="color: #647A96;">//</span>
    ...
    <section class="py-8 md:py-12 bg-surface" id="new-drops">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
                <!-- Product 1 -->
                <div class="group flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    <div class="relative aspect-[3/4] w-full bg-[#F0EDE4] overflow-hidden">
                    ...
                    <div class="p-3 sm:p-4 flex flex-col flex-1 justify-between">
                        ...
                        <div class="mt-3">
                            ...
                            <button class="mt-2.5 w-full py-2 bg-[#F0EDE4] text-[#1F2F4F] border border-[#B7C7D9] font-label-md text-label-md font-bold flex items-center justify-center gap-1.5 hover:bg-[#1F2F4F] hover:text-white transition-colors" onclick="addToCart('Heavenly Stripes Set (Ladies)- Olive')">
                ...
                <div class="group flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="p-3 sm:p-4 flex flex-col flex-1 justify-between">
                        ...
                        <div class="mt-3">
                            ...
                            <button class="mt-2.5 w-full py-2 bg-[#F0EDE4] text-[#1F2F4F] border border-[#B7C7D9] font-label-md text-label-md font-bold flex items-center justify-center gap-1.5 hover:bg-[#1F2F4F] hover:text-white transition-colors" onclick="addToCart('Heavenly Stripe Set (Men)- Baby Blue')">
                                <span class="material-symbols-outlined text-[16px]">shopping_bag</span>Add to Bag
                            </button>
                        </div>
                    </div>
                ...
                <div class="group flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="p-3 sm:p-4 flex flex-col flex-1 justify-between">
                        ...
                        <div class="mt-3">
                            ...
                            <button class="mt-2.5 w-full py-2 bg-[#F0EDE4] text-[#1F2F4F] border border-[#B7C7D9] font-label-md text-label-md font-bold flex items-center justify-center gap-1.5 hover:bg-[#1F2F4F] hover:text-white transition-colors" onclick="addToCart('Serenity Stripe Short Set Blue')">
                                <span class="material-symbols-outlined text-[16px]">shopping_bag</span>Add to Bag
                            </button>
                        </div>
                    </div>
                ...
                <div class="group flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="p-3 sm:p-4 flex flex-col flex-1 justify-between">
                        ...
                        <div class="mt-3">
                            ...
                            <button class="mt-2.5 w-full py-2 bg-[#F0EDE4] text-[#1F2F4F] border border-[#B7C7D9] font-label-md text-label-md font-bold flex items-center justify-center gap-1.5 hover:bg-[#1F2F4F] hover:text-white transition-colors" onclick="addToCart('Dots PJ 3 Pieces Set')">
                                <span class="material-symbols-outlined text-[16px]">shopping_bag</span>Add to Bag
                            </button>
                        </div>
                    </div>
    ...
    <section class="py-8 md:py-12" id="satin-section" style="background-color: #F8F6EF;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
                ...
                <div class="group flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="p-3 sm:p-4 flex flex-col flex-1 justify-between">
                        ...
                        <div class="mt-2">
                            ...
                            <button class="mt-2.5 w-full py-2 bg-[#F0EDE4] text-[#1F2F4F] border border-[#B7C7D9] font-label-badge text-label-badge uppercase font-bold hover:bg-[#1F2F4F] hover:text-white transition-colors flex items-center justify-center gap-1" onclick="addToCart('Bows Satin Pyjama Short Set')">
                ...
                <div class="group flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="p-3 sm:p-4 flex flex-col flex-1 justify-between">
                        ...
                        <div class="mt-2">
                            ...
                            <button class="mt-2.5 w-full py-2 bg-[#F0EDE4] text-[#1F2F4F] border border-[#B7C7D9] font-label-badge text-label-badge uppercase font-bold hover:bg-[#1F2F4F] hover:text-white transition-colors flex items-center justify-center gap-1" onclick="addToCart('Zebra Satin Pyjama Short Set')">
                                <span class="material-symbols-outlined text-[16px]">add_shopping_cart</span> Quick Add
                            </button>
                        </div>
                    </div>
                ...
                <!-- Satin 3 -->
                <div class="group flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow col-span-2 sm:col-span-1">
                    <div class="relative aspect-[3/4] w-full bg-[#F0EDE4] overflow-hidden">
                    ...
                    <div class="p-3 sm:p-4 flex flex-col flex-1 justify-between">
                        ...
                        <div class="mt-2">
                            ...
                            <button class="mt-2.5 w-full py-2 bg-[#F0EDE4] text-[#1F2F4F] border border-[#B7C7D9] font-label-badge text-label-badge uppercase font-bold hover:bg-[#1F2F4F] hover:text-white transition-colors flex items-center justify-center gap-1" onclick="addToCart('Red Hearts Satin Pyjama Short Set')">
                                <span class="material-symbols-outlined text-[16px]">add_shopping_cart</span> Quick Add
                            </button>
                        </div>
                    </div>
    ...
    <section class="py-8 md:py-12" id="patterned-section" style="background-color: #F8F6EF;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                <!-- Card 1 -->
                <div class="flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    <div class="relative aspect-[3/4] w-full bg-[#F0EDE4] overflow-hidden">
                    ...
                    <div class="p-4 flex flex-col flex-1 justify-between">
                        ...
                        <div class="mt-3">
                            ...
                            <button class="mt-2.5 w-full py-2 bg-[#F0EDE4] text-[#1F2F4F] border border-[#B7C7D9] font-label-md text-label-md font-bold hover:bg-[#1F2F4F] hover:text-white transition-colors flex items-center justify-center gap-1.5" onclick="addToCart('Everyday Check Set Red')">
                                <span class="material-symbols-outlined text-[16px]">shopping_bag</span> Add to Bag
                            </button>
                        </div>
                    </div>
                ...
                <div class="flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="p-4 flex flex-col flex-1 justify-between">
                        ...
                        <div class="mt-3">
                            ...
                            <button class="mt-2.5 w-full py-2 bg-[#F0EDE4] text-[#1F2F4F] border border-[#B7C7D9] font-label-md text-label-md font-bold hover:bg-[#1F2F4F] hover:text-white transition-colors flex items-center justify-center gap-1.5" onclick="addToCart('Pillow Talk Pj Lavender')">
                                <span class="material-symbols-outlined text-[16px]">shopping_bag</span> Add to Bag
                            </button>
                        </div>
                    </div>
                ...
                <div class="flex flex-col bg-white border border-[#B7C7D9] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="p-4 flex flex-col flex-1 justify-between">
                        <div>
                            ...
                            <h3 class="font-headline-sm text-headline-sm font-bold mt-1" style="color: #1F2F4F;">Stars PJ 3 Pieces Set Navy</h3>
                        </div>
                        <div class="mt-3">
                            <div class="flex items-baseline gap-2 mb-2">
                                <span class="font-headline-sm text-headline-sm font-extrabold" style="color: #1F2F4F;">LE 1,549.00</span>
                                <span class="font-body-sm text-body-sm line-through" style="color: #647A96;">LE 1,199.00</span>
                            </div>
                            <button class="w-full py-2.5 font-label-md text-label-md font-bold active:scale-95 transition-all flex items-center justify-center gap-1.5 shadow-sm" style="background-color: #1F2F4F; color: #FFFFFF;" onclick="addToCart('Stars PJ 3 Pieces Set Navy')">
    ...
    <section class="py-8 md:py-14" id="isdal-section" style="background-color: #F0EDE4;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="font-label-badge text-label-badge px-3 py-1.5 font-bold shadow-sm border" style="background-color: #FFFFFF; color: #1F2F4F; border-color: #B7C7D9;">
                    MUMMY &amp; ME
                </span>
            </div>

            <!-- Enhanced Desktop Side-by-Side Card -->
            <div class="bg-white border overflow-hidden shadow-sm p-4 sm:p-6 md:p-8" style="border-color: #B7C7D9;">
