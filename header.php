...
<header class="fixed top-0 w-full z-50 pt-safe shadow-md border-b" style="background-color: #1F2F4F; border-color: rgba(212, 181, 134, 0.25);">
    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between relative">
        ...
        <div class="flex items-center gap-2 lg:gap-8 z-20">
            ...
            <button aria-label="Open Menu" data-action="open-menu" class="w-10 h-10 flex items-center justify-center transition-colors lg:hidden mobile-only-control hover:text-[#F8F6EF]" style="color: #D4B586 !important;">
            ...
            <button aria-label="Search" data-action="open-search" class="w-10 h-10 flex items-center justify-center transition-colors lg:hidden mobile-only-control hover:text-[#F8F6EF]" style="color: #D4B586 !important;">
            ...
            <div class="hidden lg:flex items-center desktop-only-nav">
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex items-center">
                    ...
                    <?php else : ?>
                        <span class="font-extrabold text-[24px] tracking-tight hover:opacity-90 transition-opacity font-headline-lg-mobile uppercase" style="color: #D4B586 !important;">Fluff</span>
                    <?php endif; ?>
                </a>
            </div>
        </div>
        ...
        <div class="lg:hidden absolute left-1/2 -translate-x-1/2 flex items-center justify-center pointer-events-auto z-10 mobile-only-control">
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex items-center justify-center">
                ...
                <?php else : ?>
                    <span class="font-extrabold text-[22px] sm:text-[24px] tracking-tight hover:opacity-90 transition-opacity font-headline-lg-mobile uppercase" style="color: #D4B586 !important;">Fluff</span>
                <?php endif; ?>
            </a>
        </div>
        ...
        <nav class="hidden lg:flex desktop-only-nav items-center justify-center gap-4 xl:gap-7 font-label-md text-xs xl:text-sm uppercase tracking-wider font-extrabold z-10 flex-1 px-4">
            <a href="#new-drops" class="hover:text-[#F8F6EF] transition-colors py-1 whitespace-nowrap" style="color: #D4B586 !important;">New Arrivals</a>
            <a href="#satin-section" class="hover:text-[#F8F6EF] transition-colors py-1 whitespace-nowrap" style="color: #D4B586 !important;">Satin Shorts</a>
            <a href="#patterned-section" class="hover:text-[#F8F6EF] transition-colors py-1 whitespace-nowrap" style="color: #D4B586 !important;">Everyday &amp; Patterned</a>
            <a href="#isdal-section" class="hover:text-[#F8F6EF] transition-colors py-1 whitespace-nowrap" style="color: #D4B586 !important;">Isdal Family</a>
            <a href="<?php echo esc_url( home_url('/sizing-fit-advisor/') ); ?>" class="hover:text-[#F8F6EF] transition-colors py-1 whitespace-nowrap" style="color: #D4B586 !important;">Sizing Guide</a>
            <a href="<?php echo esc_url( function_exists('wc_get_page_permalink') ? wc_get_page_permalink('shop') : home_url('/shop/') ); ?>" class="hover:underline transition-colors py-1 flex items-center gap-1 font-black whitespace-nowrap" style="color: #D4B586 !important;">
        ...
        <div class="flex items-center gap-1 sm:gap-2 z-20 shrink-0">
            ...
            <button aria-label="Search" data-action="open-search" class="hidden lg:flex desktop-only-nav w-10 h-10 items-center justify-center transition-colors hover:text-[#F8F6EF]" style="color: #D4B586 !important;">
                <svg class="w-5 h-5 stroke-current" fill="none" stroke-width="1.8" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"></path>
                </svg>
            </button>
            ...
            <!-- User Account -->
            <a href="<?php echo esc_url( function_exists('wc_get_page_permalink') ? wc_get_page_permalink('myaccount') : '#' ); ?>" aria-label="User Account" class="w-10 h-10 flex items-center justify-center transition-colors hover:text-[#F8F6EF]" style="color: #D4B586 !important;">
                <svg class="w-5 h-5 stroke-current" fill="none" stroke-width="1.8" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Shopping Bag -->
            <button aria-label="Shopping Bag" data-action="open-cart" class="relative w-10 h-10 flex items-center justify-center transition-colors hover:text-[#F8F6EF]" style="color: #D4B586 !important;">
                <svg class="w-5 h-5 stroke-current" fill="none" stroke-width="1.8" viewBox="0 0 24 24" stroke="currentColor">
